...
export const BrowserComponent: React.FC<{
  ...
  <div
    className={cn(
      "relative text-sm dark:text-neutral-400 text-neutral-950 border dark:border-neutral-800 rounded-lg w-full min-h-[400px] dark:shadow-none shadow-lg shadow-gray-200 dark:dots-neutral-800 dots-gray-300 dark:bg-neutral-950 bg-white",
      className
    )}
  >
    <div
